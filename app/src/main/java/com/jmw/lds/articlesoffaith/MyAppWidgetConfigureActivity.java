...
public class MyAppWidgetConfigureActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (mAppWidgetId == AppWidgetManager.INVALID_APPWIDGET_ID) {
            Log.i(TAG, "Invalid APP ID");
            finish();
            return;
        }

//        mAppWidgetText.setText(loadTitlePref(MyAppWidgetConfigureActivity.this, mAppWidgetId));
          mAppWidgetText.setText("We claim the privilege of worshiping Almighty God according to the dictates of our own conscience, and allow all men the same privilege, let them worship how, where, or what they may."
                  );
    }
